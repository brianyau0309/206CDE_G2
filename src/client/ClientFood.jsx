...
import ClientFoodRemark from './ClientFoodRemark.jsx'
  ...
  render() {
    ...
    return(
      <div className="ClientFood translateX-3">
        ...
        <ClientFoodRemark loadBill={this.props.loadBill} open={this.state.remark} food={this.state.food_remark} remarkToggle={this.remarkToggle} orderID={this.props.orderID}/>
      </div>
    )
  }
}
