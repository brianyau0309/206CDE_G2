  ...
  render() {
    ...
    return(
      <div className="ClientCombo translateX-3" >
        {ComboList}
        <ClientComboChoice loadBill={this.props.loadBill} lang={this.state.lang} open={this.state.choice} combo={this.state.combo_choosing} choiceToggle={this.choiceToggle}/>
      </div>
    )
  }
}
